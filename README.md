...
* [`src/slds/`](src/slds/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/slds/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `slds` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/slds/config.cljs) defaults to `true` in
